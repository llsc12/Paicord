...
class DiscordUtilsTests: XCTestCase {
  ...
  func test() {
    do {
      let id =
        "\(Int.random(in: 1_000_000_000_000_000...10_000_000_000_000_000))"
    ...
    do {
      let id =
        "\(Int.random(in: 1_000_000_000_000_000...10_000_000_000_000_000))"
      let string = DiscordUtils.customAnimatedEmoji(
        name: "pwqoe",
        id: Snowflake(id)
      )
  ...
  func testEscapingSpecialCharacters() throws {
    ...
    let escapedLink = DiscordUtils.escapingSpecialCharacters(
      link,
      options: .keepLinks
    )
    ...
    let noNewLines =
      #"\*Hello!\*\n\_\_\*\*\*How are you?\*\*\*\_\_\n\> \_I'm fine thank you!\_\n\> \~Not really \:\\(\~\n\|\| Just Kidding! \|\| LOL \| HEHE"#
    let escapedLines = DiscordUtils.escapingSpecialCharacters(
      text,
      options: .escapeNewLines
    )
