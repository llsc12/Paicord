...
final class LargeDocumentParsingTests: XCTestCase {
    ...
    override func setUp() async throws {
        ...
        let configuration = DiscordMarkdownParser.Configuration(
        ...
        parser = DiscordMarkdownParser(configuration: configuration)
    ...
    private func generateLargeTestDocument() -> String {
        ...
        This is a comprehensive test document designed to stress-test the DiscordMarkdownParser
    ...
    func test_protectionMechanisms_timeoutHandling() async throws {
        ...
        let shortTimeoutConfig = DiscordMarkdownParser.Configuration(
            enableGFMExtensions: true,
            strictMode: false,
            maxNestingDepth: 100,
            trackSourceLocations: false,
        ...
        let shortTimeoutParser = DiscordMarkdownParser(configuration: shortTimeoutConfig)
